...
[@@@ocaml.warning "-3"]
(* OASIS_START *)
(* DO NOT EDIT (digest: 192ca06a7e7f919685a12b9e6c2b2ed2) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("ppx_tools_versioned.metaquot_405", None);
                   ...
                   {
                      lib_modules = ["Ppx_tyxml"; "Ppx_common"];
                      lib_pack = false;
                      lib_internal_modules =
                        [
                           "Ppx_attributes";
                      ...
                      lib_findlib_parent = Some "ppx_tyxml";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "ppx_tyxml_internal"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {
                      lib_modules = ["Ppx_tyxml_register"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tyxml";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "ppx";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "ppx_tyxml"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "ppx_tyxml_standalone.ml"
                   });
               Executable
                 ({
                     cs_name = "ppx_reflect";
     ...
     oasis_digest = Some "\223\020vU\158Y\133Z\030\2404\216\nQL\151";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
