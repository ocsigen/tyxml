...
let image_box = [%html "<div id=image_box></div>"]
...
let home_content = [%html "<div><h2>Hello Coder</h2></div>"]
let main_payload = [%html "<div id=payload>" [ home_content ] "</div>"]
...
let main_script = [%html "<script src=main.js> </script>"]
