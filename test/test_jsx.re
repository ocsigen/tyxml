...
let attribs = (
  ...
  HtmlTests.make(
    Html.[
      ...
      ( "button command",
        [<button command="show-modal"> "x" </button>],
        [button(~a=[a_command(`Show_modal)], [txt("x")])],
      ),
      ( "button custom command",
        [<button command="--my-cmd"> "x" </button>],
        [button(~a=[a_command(`Other("--my-cmd"))], [txt("x")])],
      ),
      ( "ol type lower",
        [<ol type_="a"> <li> "x" </li> </ol>],
      ...
      ( "script blocking",
        ...
        [script(~a=[a_blocking([`Render])], txt(""))],
      ),
      ...
      ( "empty option in a datalist",
        [<datalist> <option value="foo" /> </datalist>],
