    ...
    tyxml_tests
      Html.
        [
          ...
          ("div", div [ a [] ], "<div><a></a></div>");
          ("a", canvas [ a [] ], "<canvas><a></a></canvas>");
          ( "template",
            ...
            div
              [
                picture
                  ...
                  [
                    source
                      ~a:[ a_mime_type "image/webp"; a_src "picture/img1.webp" ]
                      ();
                    source
                      ~a:[ a_mime_type "image/jpeg"; a_src "picture/img2.jpg" ]
                      ();
                  ];
              ],
                ...
                picture
                  ...
                  [
                    source
                      ~a:
                        [
                          a_mime_type "image/webp";
                          a_srcset
                            [ `Url (Xml.uri_of_string "picture/img1.webp") ];
                        ]
                      ();
                    source
                      ~a:
                        [
                          a_mime_type "image/jpeg";
                          a_srcset
                            [ `Url (Xml.uri_of_string "picture/img2.jpg") ];
                        ]
                      ();
                  ];
              ],
...
let tests = [ html_elements; html_attributes; escaping ]
