...
module type T = sig
  (** SVG elements.
      ...
      Element constructors are in section {!elements}. Most elements
      ...
      the OCaml typechecker to check SVG validity.
  ...
  (** SVG attributes
      ...
      with [a_]. Attributes are given to elements with the [~a] optional
      argument.
      ...
      has two version, {!a_fill} and {!a_animation_fill}, depending on the
      element. Such disambiguated attribute will contain the name of the
      associated element. *)
  type +'a attrib
  ...
  val a_requiredExtensions : spacestrings wrap -> [> `RequiredExtension ] attrib
  ...
  val altGlyphDef
    : ([< altglyphdef_attr ], [< altglyphdef_content ], [> altglyphdef ]) unary
    [@@ocaml.deprecated "Removed in SVG2"]
  (** @deprecated Removed in SVG2 *)

  val altGlyphItem
    : ( [< altglyphitem_attr ],
        [< altglyphitem_content ],
        [> altglyphitem ] )
      star
    [@@ocaml.deprecated "Removed in SVG2"]
  (** @deprecated Removed in SVG2 *)
  ...
  val feDistantLight
    : ( [< fedistantlight_attr ],
        [< fedistantlight_content ],
        [> fedistantlight ] )
      star

  val fePointLight
    : ( [< fepointlight_attr ],
        [< fepointlight_content ],
        [> fepointlight ] )
      star
  ...
  val feColorMatrix
    : ( [< fecolormatrix_attr ],
        [< fecolormatrix_content ],
        [> fecolormatrix ] )
      star

  val feComponentTransfer
    : ( [< fecomponenttransfer_attr ],
        [< fecomponenttransfer_content ],
        [> fecomponenttransfer ] )
      star
  ...
  val feConvolveMatrix
    : ( [< feconvolvematrix_attr ],
        [< feconvolvematrix_content ],
        [> feconvolvematrix ] )
      star

  val feDiffuseLighting
    : ( [< fediffuselighting_attr ],
        [< fediffuselighting_content ],
        [> fediffuselighting ] )
      star

  val feDisplacementMap
    : ( [< fedisplacementmap_attr ],
        [< fedisplacementmap_content ],
        [> fedisplacementmap ] )
      star
  ...
  val feMorphology
    : ( [< femorphology_attr ],
        [< femorphology_content ],
        [> femorphology ] )
      star

  val feOffset : ([< feoffset_attr ], [< feoffset_content ], [> feoffset ]) star

  val feSpecularLighting
    : ( [< fespecularlighting_attr ],
        [< fespecularlighting_content ],
        [> fespecularlighting ] )
      star
  ...
  val animateColor
    : ( [< animatecolor_attr ],
        [< animatecolor_content ],
        [> animatecolor ] )
      star

  val animateTransform
    : ( [< animatetransform_attr ],
        [< animatetransform_content ],
        [> animatetransform ] )
      star
  ...
  (** Unsafe features.
      ...
      Using this module can break SVG validity and may introduce security
  ...
  module Unsafe : sig
    ...
    (** Insert an XML node that is not implemented in this module. If it is a
        standard SVG node which is missing, please report to the Ocsigen team. *)

    val leaf : string -> ?a:'a attrib list -> unit -> 'b elt
    (** Insert an XML node without children that is not implemented in this
        module. If it is a standard SVG node which is missing, please report to
        the Ocsigen team. *)
    ...
    (** Insert an attribute that is not implemented in this module. If it is a
        standard SVG attribute which is missing, please report to the Ocsigen
        team. *)
...
(** {2 Signature functors}
    ...
    See
    {% <<a_manual chapter="functors"|the manual of the functorial interface>> %}. *)
