...
If your `Xml` implementation uses a special function wrapping, use [`Make_with_wrapped_functions`](./Svg_f-Make_with_wrapped_functions.md).
...
Note that the concrete implementation of this type can vary. See [`Xml`](./Svg_f-Make-Xml.md) for details.
