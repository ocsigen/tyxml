...
see [http://www.w3.org/TR/SVG](http://www.w3.org/TR/SVG) W3C Recommendation
Concrete implementation of Svg typesafe constructors. See [`Svg_sigs.T`](./Svg_sigs-module-type-T.md).
...
Note that the concrete implementation of this type can vary. See [`Xml`](./Tyxml_svg-Xml.md) for details.
