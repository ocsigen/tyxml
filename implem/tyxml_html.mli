...
(** Concrete implementation of Html typesafe constructors. See
    {!module-type:Html_sigs.T}. *)
include
  Html_sigs.Make(Tyxml_xml)(Tyxml_svg).T with module Xml.W = Xml_wrap.NoWrap
...
val _pp : Format.formatter -> doc -> unit [@@ocaml.toplevel_printer]
val _pp_elt : Format.formatter -> _ elt -> unit [@@ocaml.toplevel_printer]
