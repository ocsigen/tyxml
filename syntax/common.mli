...
val make_lid : loc:Location.t -> lang -> string -> Longident.t Location.loc
val make : loc:Location.t -> lang -> string -> expression
...
val wrap : lang -> Location.t -> expression -> expression
...
val wrap_value : lang -> Location.t -> expression value -> expression
val list_wrap_value : lang -> Location.t -> expression value list -> expression
val error : Location.t -> ('b, Format.formatter, unit, 'a) format4 -> 'b
val txt : loc:Location.t -> lang:lang -> string -> expression
